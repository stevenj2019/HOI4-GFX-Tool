...
this is no longer being maintained, you should use this [tool](https://github.com/stevenj2019/ParadoxEdit) instead (it sucks less) 
this should still work..... feel free to use, feel free to pillage the code, use it as you wish.
